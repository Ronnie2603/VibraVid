...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['arr_source', 'arr_id'], name='searchapp_a_arr_sou_idx'),
        ),
        migrations.AddIndex(
            model_name='arrmediarequest',
            index=models.Index(fields=['status'], name='searchapp_a_status_idx'),
        ),
        migrations.AddIndex(
            model_name='arrmediarequest',
            index=models.Index(fields=['content_type'], name='searchapp_a_content_idx'),
        ),
    ]
