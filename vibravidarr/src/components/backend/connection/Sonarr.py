...
class Sonarr:
	...
	def commandDownloadedEpisodesScan(self, path: str) -> httpx.Response:
		"""
        Ordina a Sonarr di scansionare una cartella specifica per importare gli episodi appena scaricati.
        """
		return self.client.post("/command", json={
